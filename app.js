...
const state = { shape: 'hex', columns: 9, rows: 7, projection: 'top', tilt: 30, terrain: 'plain', curvature: 65, unit: { q: 0, r: 0 } };
...
const terrainHeightAt = (x, y, width, height) => {
  ...
  if (state.terrain === 'sphere') return state.curvature/100*Math.max(0, 82-(nx*nx+ny*ny)*250);
